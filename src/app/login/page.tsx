...
export default function LoginPage() {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            // setLoading(false); // Usually redirect happens, so we keep loading state
        }
    };
            ...
            <div className="w-full max-w-md space-y-8 rounded-xl border border-border bg-card p-10 shadow-lg">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                        Start creating amazing product descriptions with AI
                    </p>
                </div>
                ...
                <div className="mt-8 space-y-6">
                    ...
                    >
                        {loading ? (
                            ...
                            // If react-icons is problematic, we can use a text placeholder or svg
